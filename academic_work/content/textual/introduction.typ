...
Dentre as categorias existentes, destacam-se os @jogo_turno:pl, em que o tempo ocorre em unidades discretas.
...
O mercado dos @jogo_tabuleiro:pl modernos teve um marco com o lançamento de #emph[Colonizadores de Catan] @teuber:1995:catan, quando @jogo:pl contemporâneos se tornaram populares mundialmente a partir da Alemanha e criaram um novo movimento cultural.
...
Esta etapa de @pt, na qual @partida:pl do @jogo são performadas repetidamente, tem alto custo de recursos humanos.
...
A nível específico, é proposto um ambiente de @pt simulado para auxiliar as pessoas autoras de @jogo:pl a realizar as primeiras iterações do processo de teste.\
